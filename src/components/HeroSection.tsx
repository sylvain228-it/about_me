    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-16 pt-14 sm:px-6 sm:pb-20 sm:pt-20 lg:px-8 lg:pt-24">
        ...
        >
          ...
          <p className="mt-4 text-lg font-medium text-slate-700 sm:text-xl dark:text-slate-200">{profile.role}</p>
        ...
        >
          <div className="rounded-2xl border border-slate-200/80 bg-white/60 p-5 backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/40">
            ...
            <dd className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">{profile.yearsExperience}</dd>
            <dd className="mt-1 text-sm text-slate-600 dark:text-slate-400">Production logicielle au quotidien</dd>
          </div>
          <div className="rounded-2xl border border-slate-200/80 bg-white/60 p-5 backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/40">
            <dt className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">
              Poste actuel
            ...
            <dd className="mt-1 text-sm text-slate-600 dark:text-slate-400">Depuis {profile.experience.since}</dd>
          </div>
          <div className="rounded-2xl border border-slate-200/80 bg-white/60 p-5 backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/40">
            <dt className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">
              Focus
            ...
            <dd className="mt-1 text-sm text-slate-600 dark:text-slate-400">Architecture propre, utilisateurs réels</dd>
          </div>
        </motion.dl>
      </div>
    </section>
