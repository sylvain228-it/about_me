...
export const profile = {
  ...
  location: "Lomé, Togo",
  avatar: "/src/assets/me_about.png",
  tagline:
  ...
  phone: "+228 93 57 12 79",
  social: {
    github: "https://github.com/sylvain228-it",
    linkedin: "https://www.linkedin.com/in/sylvain228/",
    /** E.164 sans + pour wa.me */
    whatsapp: "https://wa.me/22893571279",
  },
  experience: {
    company: "DTECH GROUP",
  ...
  skills: {
    ...
    backend: ["PHP (Laravel)", "Node.js (NestJS)", "Python (Django)"],
    mobile: ["Flutter"],
